...
def move_park_p():
    park_source = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test/Park_P.txt'
    park_dest = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test/Park_P_Temp.txt'

    park_cooked = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test/Park_P_Temp.txt'
    park_custom = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps'
...
# Disables button to load default map when it's already loaded.
    if "Park_P_Temp.txt" in os.listdir('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps'):
...
def return_park_p():
    ...
    park_cooked = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test'
    park_custom = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P_Temp.txt'
...
def return_park_p_error():
    ...
    park_custom = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P.txt'
...
def move_custom_map():
    ...
    maps_path_ = ('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/', map_name_)
    map_source_ = ''.join(maps_path_)

    map_dest = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P.txt'
    map_cooked = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test'

    os.rename(map_source_, map_dest)
    shutil.move('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P.txt', map_cooked)

# Updates Current Map text
    map_name_ = maps.get('active')

    if map_name_ != "Park_P_Temp.txt":
...
def return_custom_map():
    ...
    maps_path__ = ('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/', map_name__)
    map_source__ = ''.join(maps_path__)

    park_source = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test/Park_P.txt'
    park_source_og = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test/Park_P_Temp.txt'
    park_custom = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P_Temp.txt'
    park_dest = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps'
    park_cooked = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CookedPCConsole_test'
    park_p_custom = '/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/Park_P.txt'
    ...
    if "Park_P_Temp.txt" not in os.listdir('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps'):
...
def open_maps_folder():
    webbrowser.open('C:/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps')
...
maps_in_directory = os.listdir('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps')
y=1
...
maps_path = ('/Users/Jorge/PycharmProjects/Rocket League Map Loader/CustomMaps/', map_name)
